...
class ProfCoursTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void {
        ...
        self::$cours_a = [
            new Cours("Cours1", "2h", 1),       // idcours = 1
            new Cours("Cours2", "2.5h", 3),     // idcours = 2
            new Cours("Cours3", "3h", 5),       // idcours = 3
            new Cours("Cours4", "2h", 3),       // idcours = 4
            new Cours("Cours5", "3h", 3),       // idcours = 5
            new Cours("Cours6", "2h", 4),       // idcours = 6
            new Cours("Cours7", "3h", 5),       // idcours = 7   ** A SUPPRIMER **
            new Cours("Cours8", "4h", 5),       // idcours = 8
            new Cours("Cours9", "3h", 5)        // idcours = 9   ** A MODIFIER **
        ];
    }
    ...
    public function testPrintAll()
    {
        ...
        $this->assertCount(count(self::$cours_a), $record_cours_a, "Nombre d'enregistrement égal pour Cours\n");
    }
